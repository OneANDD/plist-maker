...
- [ ] Export the checkpointed project to a new GitHub repository named `plist-maker` through the Management UI once the GitHub connection control is responsive.
